...
class IncrementalAlgorithmRelational5(object):
    def __init__(self, context = {}, target = str, preferred_attributes = [], frequencia = {}, probabilidade = float, tamanho = int, restricaoContexto = False):
        self.context = context
        self.dominio = self.initializeDominio(context)
        self.target = target
