...
def countAttributeFrequencyIndividual(folds, teste):
    ...
    for fold in foldsAux:
        for anotacao in folds[fold]:
            ...
            for objeto in anotacao["anotacoes"]:
                for key in anotacao["anotacoes"][objeto].keys():
                    if objeto == target:
...
def defineExpressao(previsoes, dominio, target):
    ...
    relacional = False
    landmark = str
    for atributo in ["type","name","other","relation","lm_type","lm_name","lm_other"]:
        ...
        if len(element) == 1 and atributo != "relation":
            ...
            if previsoes[atributo] == 0:
                ...
                del descricao[target]["in"]
                del descricao[target]["between"]
                del descricao[target]["next-to"]
                del descricao[target]["right-to"]
                del descricao[target]["left-to"]
                ...
                if previsoes[atributo] == 1:
                    ...
                    if len(descricao[target]["between"]) == 0:
                        del descricao[target]["between"]
                    else:
                        landmark = descricao[target]["between"][0]
                        descricao[landmark] = {}
                        relacional = True
                        ...
                        del descricao[landmark]["in"]
                        del descricao[landmark]["next-to"]
                        del descricao[landmark]["right-to"]
                        del descricao[landmark]["left-to"]
                        del descricao[landmark]["between"]
                    ...
                    if len(descricao[target]["right-to"]) == 0:
                        del descricao[target]["right-to"]
                    else:
                        landmark = descricao[target]["right-to"][0]
                        descricao[landmark] = {}
                        relacional = True
                    ...
                    if len(descricao[target]["left-to"]) == 0:
                        del descricao[target]["left-to"]
                    else:
                        landmark = descricao[target]["left-to"][0]
                        descricao[landmark] = {}
                        relacional = True
                    ...
                    if len(descricao[target]["behind"]) == 0:
                        del descricao[target]["behind"]
                    else:
                        landmark = descricao[target]["behind"][0]
                        descricao[landmark] = {}
                        relacional = True
                    ...
                    if len(descricao[target]["in"]) == 0:
                        del descricao[target]["in"]
                    else:
                        landmark = descricao[target]["in"][0]
                        descricao[landmark] = {}
                        relacional = True
