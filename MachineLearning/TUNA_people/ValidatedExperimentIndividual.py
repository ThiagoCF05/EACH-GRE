...
def run(trials, atributos, incluiParticipante):
    folds = cross.crossValidationParticipant(10, trials)
    ...
    for participante in folds.keys():
        resultadoTotal, dice, masi, acuracia = exp4.run(trials, folds[participante], atributos, {}, incluiParticipante)
