...
def run(dominios, targets, anotacoes, atributos, participantes, incluiParticipante):
    ...
    for participante in folds.keys():
        resultadoTotal, dice, masi, acuracia = exp4.run(dominios, targets, folds[participante], atributos, participantes, incluiParticipante)
