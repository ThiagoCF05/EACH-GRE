...
def defineExpressao(previsoes, dominio, target):
    ...
    landmark = str
    second_landmark = ""
    for atributo in ["type", "colour", "size", "hpos", "vpos", "below", "above", "left", "right", "near", "in-front-of", "lm_type", "lm_colour", "lm_size", "lm_hpos", "lm_vpos", "lm_below", "lm_above", "lm_left", "lm_right", "lm_near", "lm_in-front-of", "lm2_type", "lm2_colour", "lm2_size", "lm2_hpos", "lm2_vpos"]:
        ...
        if len(element) == 1:
            if previsoes[atributo] == 0:
                ...
                if atributo in ["below", "above", "left", "right", "near", "in-front-of"]:
            ...
            if element[0] == "lm":
                if previsoes[atributo] == 0:
                    ...
                    if element[1] in ["below", "above", "left", "right", "near", "in-front-of"]:
                        if len(descricao[landmark][element[1]]) > 0:
                            ...
                            for key in dominio[second_landmark].keys():
                                if key not in ["below", "above", "left", "right", "near", "in-front-of"]:
