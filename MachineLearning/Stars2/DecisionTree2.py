...
def test(svms, teste):
    ...
    for anotacao in teste:
        ...
        for svm1 in svms:
            ...
            if svm1 in ["lm_type", "lm_colour", "lm_vpos", "lm_hpos", "lm_size"] and anotacao["classes"]["relation"] > 0:
            ...
            elif svm1 in ["lm2_type", "lm2_colour", "lm2_vpos", "lm2_hpos", "lm2_size"] and anotacao["classes"]["lm_relation"] > 0:
                if real == resultado[0]:
                    acertos[svm1] = acertos[svm1] + 1.0
                ...
                if real == 0 and resultado[0] == 0:
                    ...
                    fp[svm1] = fp[svm1] + 1
            elif svm1 not in ["lm_type", "lm_colour", "lm_vpos", "lm_hpos", "lm_size", "lm2_type", "lm2_colour", "lm2_vpos", "lm2_hpos", "lm2_size"]:
