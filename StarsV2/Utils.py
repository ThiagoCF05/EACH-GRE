...
def defineExpressao(expressao, frequencias, tamanhoTreinamento, dominio):
    ...
    previsoes = {"type":expressao["previsoes"]["type"],"colour":expressao["previsoes"]["colour"],"hpos":expressao["previsoes"]["hpos"],"vpos":expressao["previsoes"]["vpos"], "relation":expressao["previsoes"]["relation"]}
    
    frequency = {}
    for atributo in ["near", "left", "right", "above", "below"]:
    ...
    previsoes = {"lm_type":expressao["previsoes"]["lm_type"],"lm_colour":expressao["previsoes"]["lm_colour"],"lm_hpos":expressao["previsoes"]["lm_hpos"],"lm_vpos":expressao["previsoes"]["lm_vpos"], "lm_relation":expressao["previsoes"]["lm_relation"]}
