...
#     folds = cross.crossValidation(10, annotations)
    ...
    for testeFold in folds:
        ...
        for expressao in expressoes:
            ...
            descricao = utils.defineExpressao(expressao, frequencias[testeFold][participante], participantes[testeFold][participante]["numeroExpressoes"], dominios[contexto], targets[contexto])
